...
class CodeValidationScreen extends StatelessWidget {
        ...
        children: [
          ...
          Form(
            ...
            child: ButtonWithIcon(
              ...
              text:
                  globalController.lang.value == "fr" ? "Valider" : "Validate",
              onPressed: () async {
                bool isValidate =
          ...
          TextButton(
            onPressed: () async {
              if (controller.loading == false) {
                await controller
                    .sendValidationCode(globalController.appuser.value.email!);
              }
            },
            child: Text(
              globalController.lang.value == "fr"
  ...
  SingleChildScrollView codevalidationTablet(
      double screenWidth,
      double screenHeight,
      GlobalController globalController,
      CodeValidationController controller) {
                ...
                Visibility(
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        ...
                        style:
                            TextStyle(color: MyColors.MainRedBig, fontSize: 18),
                      ),
                    )),
                TextButton(
                  onPressed: () async {

...
class LandingScreen extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: globalController.devType.value == "tablet"
            ? landingscreenTablet(screenHeight, screenWidth, globalController)
            : landingscreenAndroid(screenHeight, globalController, screenWidth),
      ),
    );
  }

  Column landingscreenAndroid(double screenHeight,
      GlobalController globalController, double screenWidth) {
    return Column(
      children: [
        SizedBox(
  ...
  Center landingscreenTablet(double screenHeight, double screenWidth,
